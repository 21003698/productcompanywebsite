...
<html lang="en">
  <head>
    <title>Vshagna Private Limited</title>
  ...
  <body>
    <div class="container">
      <div class="banner">Vshagna Private Limited.</div>
      <div class="menu">
      ...
      <div class="content">
        <div class="homecontent">
          ...
          <div class="contenttext">
            We Vshagna pvt.ltd provide many original softwares for low prices than than the original prices.
      ...
      <div class="footer">
        Copyright &#169; 2021 Vshagna Private Limited, Developed by Sandeep.
      </div>
    </div>
  </body>
</html>
...
.banner {
  ...
  text-align: center;
  font-size: 60px;
  background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXvd9hmh39fU95TAPME13q1yU2fd7UUz0eJg&usqp=CAU");
